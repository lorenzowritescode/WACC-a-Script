...
the program has exited with an error. Any value \lit{n} passed to the exit call greater than 255 or less than 0 will be wrapped around to the value :
\lit{n} \% 256.
...
\item The \lit{chr} operator returns the character whose ASCII values corresponds to that given number. 
