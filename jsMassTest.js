...
function printResult() {
    console.log("TOTAL: " + testStatus.total + " | PASSED: " + testStatus.passed + " | DON'T KNOW: " + testStatus.dontknow + " | SYNTAX ERROR: " + testStatus.syntax + " | RUNTIME ERROR: " + testStatus.runtime)
}